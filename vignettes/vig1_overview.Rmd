...
Many statistical models -- espeicially if they are Bayesian statistical models -- produce random draws from a distribution. A useful feature of these draws is that they can be used to make inferences about derived quantities. The procedure is:
