...
Tools for working posterior distributions, prior distributions, or simulation output. An rvec holds multiple draws from a distribution, but behaves as much as possible like a standard R vector.


## Installation

You can install the development version of rvec from [GitHub](https://github.com/) with:
